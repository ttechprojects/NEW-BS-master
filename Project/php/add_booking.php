          ...
          if($res=mysqli_query($con,$sql))
            {
              ...
              if($res1=mysqli_query($con,$sql_get_id)){
                  ...
                  $sql1= "update booking  set r_id = (select r_id from rooms where r_id not in (select r_id from (select * from booking) as b where b.s_time<'".$ms1."' and b.e_time > '".$me1."') and capacity>=".$nog."  and tv>=".$tv." and projector>=".$projector." and pc>=".$pc." and ip_board>=".$ip." and dvd>=".$dvd." and podium_microphone>=".$podium." and cordless_microphone>=".$cordless." and lap_microphone>=".$lap." and video_conferencing>=".$conference." order by capacity limit 1) where m_id = ".$m_id.";";
                    //echo $sql1;
                  }
